            ...
            <div className="container">
                <div className="well">
                    ...
                    <div className="col-xs-1">
                        <button className="btn btn-info btn-circle" onClick={() => this.props.changeShowAddContact(true)}>
                ...
                <div className="panel panel-default panel-borderless">
                    <div className="panel-body">
                        <InputName searchContact={this.props.searchContact} name={this.props.name} changeName={this.props.changeName}/>
                    </div>
                </div>
                <ContactList contacts={this.props.contacts} deleteContact={this.props.deleteContact} />
                {this.props.showAddContact ? <AddContact addContact={this.props.addContact} changeShowAddContact={this.props.changeShowAddContact} /> : ''}
